...
export default class Parser {
    ...
    private parse_var_declaration():Stmt {
        ...
        const identifier = this.expect(TokenType.Identifier,"Expected Identifier following let or const keywords.",).value;
        ...
        this.expect(TokenType.Equals, "Expected '=' token following identifier in var declaration.");
        const declaration = { kind:"VarDeclaration",identifier:identifier, value: this.parse_expr(),constant:isConstant } as VarDeclaration;
    ...
    private parse_object_expr():Expr {
        ...
        while (this.not_eof() && this.at().type != TokenType.CloseBrace) {
            ...
            this.expect(TokenType.Colon, "Missing colon flowing identifier in ObjectExpr");
